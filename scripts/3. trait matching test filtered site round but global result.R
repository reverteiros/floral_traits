# this script generates simulated visits for each bee species based on the
# flower visit frequencies at all site rounds at which the focal bee was
# detected.
# it produces a bunch of plots for the differences between bee tongue length and
